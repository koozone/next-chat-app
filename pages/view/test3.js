...
export const VariableArea = (props) => {
	...
	return (
		<div className={`relative bg-gray-500 rounded-lg ring-1 ring-gray-900 ring-opacity-5 overflow-hidden`}>
			<div className="block">
				<div className="min-w-full sm:min-w-[400px] relative sm:pr-4" style={{maxWidth: '100%', width: `${sizeData.previousLeft}px`}}>
					<div className="bg-white h-auto">
						<div className="h-80"></div>
						<div
							className={`sr-only sm:not-sr-only sm:border-l sm:${sizeData.hasCapture ? 'bg-red-500' : 'bg-gray-100'} sm:absolute sm:right-0 sm:inset-y-0 sm:flex sm:justify-center sm:items-center sm:w-40 cursor-[ew-resize]`}
