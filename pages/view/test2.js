		...
		<div>
			...
			<div className="px-8 mt-10">
				<div className="mx-auto lg:w-3/5 lg:h-auto lg:flex lg:flex-row">
					<img
						className="rounded-tl-lg rounded-tr-lg h-48 w-full lg:h-auto lg:w-2/5 lg:rounded-bl-lg lg:rounded-tr-none"
						...
						alt=""
					/>
					<div className="bg-white p-8 rounded-bl-lg rounded-br-lg lg:rounded-bl-none lg:rounded-tr-lg">
						...
						<div className="flex items-center mt-8">
							<div className="flex items-center">
								<img className="h-10 w-10 rounded-full" src="https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=761&q=80" alt="" />
								<div className="ml-4">
