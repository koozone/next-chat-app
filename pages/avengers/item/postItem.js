...
export const PostItem = (props) => {
	...
	return (
		<figure className="md:flex bg-slate-100 rounded-xl p-8 md:p-0 dark:bg-slate-800 overflow-hidden">
			<img className="object-cover w-24 md:w-48 md:h-auto md:rounded-none rounded-full mx-auto" src={src} alt="" width="384" height="512" />
			<div className="pt-6 md:p-8 text-center md:text-left space-y-4 text-slate-900 dark:text-slate-300 ">
				<blockquote>
