...
export function Header2() {
	...
	return (
		<div className="sticky top-0 flex justify-between items-center bg-[#300b3f85] h-12 z-10">
			...
			<div className="flex space-x-2">
				...
				<Img deco="im-1" src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2.25&w=256&h=256&q=80"></Img>
			</div>
		</div>
	);
}
