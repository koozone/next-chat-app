...
const getStyle = (props) => {
	...
	const defaultElement = (() => {
		switch (`[${tag}]`) {
			...
			case '[checkbox222]':
				return <div className={`group flex justify-center items-center relative cursor-pointer select-none`} />;
...
export const Checkbox222 = (props) => {
	const {children, deco, style, className, name, id, onChange, checked, disabled} = getProps({...props, tag: 'checkbox222'});
